		...
		<div class="container">
			...
			<div class="row justify-content-center">
				...
				<div class="tips-item row pin mr-sm-0 ml-sm-0">
									<div class="col-12 col-md-9 pr-0 pl-sm-0">
									@php
                                    if($football->image_thumb){
                                        $img = Storage::url($football->image_thumb);
                                    }else{
                                        $img = '';
                                    }
									...
									<div class="col-12 col-md-3 d-flex pl-0 pr-sm-0">
										<div class="detail">
											<div class="title">{{ $football->title }}</div>
											<div class="excerpt">
												{{ $football->description }}
											</div>
											<a class="btn btn-lightblue d-block font-med" href="{{ url('/tips/detail/'.$football->id) }}">อ่านเพิ่มเติม</a>
										</div>
									</div>
								</div>
				</div>
